...
public class EPsell extends JavaPlugin {
	...
	public void onEnable() {
		System.out.println(nameC + "Das Plugin ist aktiviert");
		prepareConfig();
		prepareEconomy();
	}
	...
	public void onDisable() {
		System.out.println(nameC + "Plugin von MrKaytzo und Xiretza");
		System.out.println(nameC + "Das Plugin ist deaktiviert");
	}
	...
	public void addMoney(String player, double amountXP) {
		...
		if(economy.isEnabled()) {
			...
			p.sendMessage(nameP + "Erfolgreich " + amountXP + " XP für " + amount + " " + economy.currencyNamePlural() + " verkauft.");
			p.sendMessage(nameP + "Dein neuer Kontostand: " + economy.getBalance(player) + " " + economy.currencyNamePlural());
		}
	}
}
